...
**케어랩스 굿닥 iOS 개발 인턴** : 2019.02.12 ~ 2019.05.10

- 네이버 지도 V2 API 서비스 종료로 네이버 지도 V3 API로 교체
  - 지도 매니저 클래스를 델리게이트 패턴으로 여러 곳에서 쉽게 재사용할 수 있도록 설계
- 지루한 인트로 화면을 스켈레톤 뷰 패턴으로 개선
  - 일반적이 앱 실행뿐만 아니라 딥 링크 진입 혹은 애플리케이션 숏컷을 통한 앱 진입 시에 보다 빠른 화면 전환 효과를 보인다.
  
**케어랩스 굿닥 iOS 개발** : 2019.05.13 ~
